...
file = './tcpSolution-Re-10595-nutinf-3-mesh-1.dat'
...
ax1.pcolor(xi, yi, qi, cmap='RdBu', vmin=-0.4, vmax=1.2)
plt.contour(xi,yi,qi,14,linewidths=0.5,colors='k', levels=np.linspace(-0.4, 1.2, 17))
cntr1 = ax1.contourf(xi, yi, qi, 14, cmap="RdBu", levels=np.linspace(-0.4, 1.2, 17))
fig.colorbar(cntr1, ax=ax1)
ax1.set_xlabel( r"$x/h$",fontsize=17)
ax1.set_ylabel( r"$y/h$",fontsize=17)
fig.subplots_adjust(bottom=0.18)
#fig.savefig("fig_rans_u.png", dpi=600)
plt.show()
